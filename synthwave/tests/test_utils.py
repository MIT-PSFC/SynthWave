...
from synthwave.magnetic_geometry.utils import cylindrical_to_cartesian, cartesian_to_cylindrical
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([3, np.pi/4, -1], [3/np.sqrt(2), 3/np.sqrt(2), -1]),  # R=3, phi=pi/4, Z=-1
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([3/np.sqrt(2), 3/np.sqrt(2), -1], [3.0, np.pi/4, -1.0]),  # x=y=3/sqrt(2), z=-1
